	  ...
	  var child;
        ...
        snapshot.forEach(function(childSnapshot) {
         ...
         if (child.confirmed == false ){
			 	 trt += '<div class="media"><div class="media-left"><a href="#"><img alt="..." src="images/user.png" style="width:15%" class="media-object"></a></div><div class="media-body"><h4 class="media-heading">'+child.nomPatient+'</h4><p>'+child.details+'</p><p class="comment-date">'+child.date + "  " + child.time+'</p><button onClick="consulter('+child.codePatient+",'"+ child.nomPatient+"','"+child.type+ "','"+child.details+ "'"+ ')" data-toggle="modal"  data-target="#myModal" type="button" class="pull-right btn btn-dark btn-outline btn-rounded m-b-10 m-l-5">Consulter</button>	</div>	</div>';
